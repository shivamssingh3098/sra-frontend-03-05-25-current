        ...
        <div className="space-y-6 text-sm">
          ...
          <div className="mt-8">
            <p className="font-medium text-wrap" style={{ marginLeft: "40px" }}>
              ...
              झोपडपट्टीधारकांच्या बँक खात्यावर भाडे प्रदान तपशीलाच्या सत्यप्रती
            ...
            <div className="space-y-4">
              <p>
                ...
                {formData.district || "_______"} जिल्हा येथील{" "}
                {formData.mahanagar || "_______"} महानगरपालिका हद्दीतील सेक्टर
                क्र./वार्ड क्र {formData.bhukhandNo || "_______"} मधील न.भू.क्र{" "}
                {formData.wardNo || "_______"} येथील{" "}
                {formData.sahagruh || "_______"} सहकारी गृहनिर्माण संस्थेच्या
                झोपडपट्टी पुनर्वसन योजना विकासक {formData.wiksit || "_______"}{" "}
          ...
          <div className="mt-8 space-y-2 text-sm">
            ...
            <ol className="list-decimal pl-6 space-y-2 leading-relaxed text-sm">
              ...
              <li>
                ...
                आत प्रथम अपीलीय अधिकाऱ्यांकडे अपील दाखल करावे.
              </li>
            </ol>
          </div>
        </div>
        ...
        <div className="rightside w-25" style={{ height: "80vh" }}>
          ...
          >
            ...
            >
              <Modal.Header closeButton>
                <Modal.Title>
                  {uploadType.toUpperCase()} - Upload File
                </Modal.Title>
              </Modal.Header>
