          ...
          <div id="formFinal" className="p-4">
            ...
            <div className="text-center mb-6">
              <div className="flex justify-between items-start mb-4">
                <div className="text-left flex  ml-[50%]">सेवा क्र. ११</div>
              </div>
            ...
            <div className="space-y-6 text-sm">
              ...
              <div className="mt-8">
                ...
                >
                  विषय :- संस्थेची नोंदणी करण्यासाठी अर्ज.
                </p>
                ...
                <div className="space-y-4">
                  <p>
                    ...
                    गृहनिर्माण संस्थेच्या झोपडपट्टी पुनर्वसन योजनेसाठी संस्था
                    नोंदणी करावयाची आहे. तरी सोबत जोडलेल्या विहित नमुन्यातील
                    अर्जनुसार आमचे संस्थेची नोंदणी करून आम्हाला नोंदणी
                    प्रमाणपत्र दयावे, ही विनंती.
                  </p>
                </div>
              </div>
