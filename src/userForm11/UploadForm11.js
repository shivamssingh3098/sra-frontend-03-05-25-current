...
const UploadForm11 = ({ formData, formId, setCanProceed, onFormSubmit }) => {
  ...
  const [files, setFiles] = useState({
    aadharCard: null,
    bankStatement: null,
    documentsForSigningBankApplication: null,
    annexureA_C: null,
    preRegistrationMeetingDraftInstitution: null,
    otherDocument1: null,
    scheme: null,
    signature: null,
    otherDocument2: null,
        ...
        <div className="w-full max-w-6xl bg-white rounded-lg shadow p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              <label className="flex items-start text-sm font-medium text-gray-700">
                <span className="text-red-500 mr-1">*</span>
                बँकेचे खाते विवरण ( Bank statement )
              </label>
              <div className="relative">
                <input
                  type="file"
                ...
                {files.bankStatement && (
                  <div className="mt-2 text-sm text-gray-600">
                    <p>Selected: {files.bankStatement.name}</p>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input
                  type="file"
                  className="hidden"
                  id="documentsForSigningBankApplication"
                  accept=".pdf,.jpg,.jpeg,.png"
                  onChange={(e) =>
                    handleFileChange(e, "documentsForSigningBankApplication")
                  }
                />
                <label
                  htmlFor="documentsForSigningBankApplication"
                  className="flex items-center gap-2 w-full border-2 border-dashed border-gray-300 rounded-lg p-4 hover:border-blue-500 cursor-pointer transition-colors group"
                >
                  <div className="p-2 rounded-full bg-blue-50 group-hover:bg-blue-100">
                    <svg
                ...
                {files.documentsForSigningBankApplication && (
                  <div className="mt-2 text-sm text-gray-600">
                    <p>
                      Selected: {files.documentsForSigningBankApplication.name}
                    </p>
                    {previews.documentsForSigningBankApplication && (
                      <img
                        src={previews.documentsForSigningBankApplication}
                        alt="Preview"
                        className="mt-2 max-w-full sm:max-w-xs rounded mx-auto"
                      />
                    )}
            ...
            <div className="space-y-2">
              <label className="flex items-start text-sm font-medium text-gray-700">
                <span className="text-red-500 mr-1">*</span>
                संस्थेच्या नोंदणीपुर्व सभेच्या ठरवायची प्रत
              </label>
              <div className="relative">
                <input
                  type="file"
                  className="hidden"
                  id="preRegistrationMeetingDraftInstitution"
                  accept=".pdf,.jpg,.jpeg,.png"
                  onChange={(e) =>
                    handleFileChange(
                      e,
                ...
                />
                <label
                  htmlFor="preRegistrationMeetingDraftInstitution"
                  className="flex items-center gap-2 w-full border-2 border-dashed border-gray-300 rounded-lg p-4 hover:border-blue-500 cursor-pointer transition-colors group"
                >
                  <div className="p-2 rounded-full bg-blue-50 group-hover:bg-blue-100">
                    <svg
                ...
                {files.preRegistrationMeetingDraftInstitution && (
                  <div className="mt-2 text-sm text-gray-600">
                    <p>
                      Selected:{" "}
                      {files.preRegistrationMeetingDraftInstitution.name}
                    </p>
                    {previews.preRegistrationMeetingDraftInstitution && (
                      <img
                        src={previews.preRegistrationMeetingDraftInstitution}
                        alt="Preview"
                        className="mt-2 max-w-full sm:max-w-xs rounded mx-auto"
                      />
                    )}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input
                  ...
                  id="annexureA_C"
                  accept=".pdf,.jpg,.jpeg,.png"
                  onChange={(e) => handleFileChange(e, "annexureA_C")}
                />
                <label
                  htmlFor="annexureA_C"
                  className="flex items-center gap-2 w-full border-2 border-dashed border-gray-300 rounded-lg p-4 hover:border-blue-500 cursor-pointer transition-colors group"
                ...
                {files.annexureA_C && (
                  <div className="mt-2 text-sm text-gray-600">
                    <p>Selected: {files.annexureA_C.name}</p>
                    {previews.annexureA_C && (
                      <img
                        src={previews.annexureA_C}
                        alt="Preview"
                        className="mt-2 max-w-full sm:max-w-xs rounded mx-auto"
                      />
                    )}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                {files.scheme && (
                  <div className="mt-2 text-sm text-gray-600">
                    <p>Selected: {files.scheme.name}</p>
                    {previews.scheme && (
                      <img
                        src={previews.scheme}
                        alt="Preview"
