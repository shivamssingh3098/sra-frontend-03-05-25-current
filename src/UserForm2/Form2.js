...
const Form2 = ({ formData: initialFormData, formId }) => {
  console.log("Form2 Component Rendered with:", { initialFormData, formId });
  ...
  const CertificateStage = ({ formData }) => {
    ...
    const serviceDescription =
      servicesData[0].services.find((service) => service.id === 2)
        ?.description || "";
              ...
              <div className="mt-8">
                ...
                <div className="space-y-4">
                  <p>
                    ...
                    मुंबई झोपडपट्टी पुनर्वसन प्राधिकरण यांचे मार्फत देण्यात
                    आलेल्या NOC घो प्रमाणीत प्रत उपलब्ध करुन द्याव्यात हि
                    विनंती.
                  </p>
                </div>
              </div>
