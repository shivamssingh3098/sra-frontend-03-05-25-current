            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input
                  type="file"
                  className="hidden"
                  id="bankPassbookFirstCopy"
                  accept=".pdf,.jpg,.jpeg,.png"
                  onChange={(e) => handleFileChange(e, "bankPassbookFirstCopy")}
                />
                <label
                  htmlFor="bankPassbookFirstCopy"
                  className="flex items-center gap-2 w-full border-2 border-dashed border-gray-300 rounded-lg p-4 hover:border-blue-500 cursor-pointer transition-colors group"
                >
                  <div className="p-2 rounded-full bg-blue-50 group-hover:bg-blue-100">
                    <svg
                ...
                {files.bankPassbookFirstCopy && (
                  <div className="mt-2 text-sm text-gray-600">
                    <p>Selected: {files.bankPassbookFirstCopy.name}</p>
                    {previews.bankPassbookFirstCopy && (
                      <img
                        src={previews.bankPassbookFirstCopy}
                        alt="Preview"
                        className="mt-2 max-w-full sm:max-w-xs rounded mx-auto"
                      />
                    )}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input
                  type="file"
                  className="hidden"
                  id="prescribedApplication"
                  accept=".pdf,.jpg,.jpeg,.png"
                  onChange={(e) => handleFileChange(e, "prescribedApplication")}
                />
                <label
                  htmlFor="prescribedApplication"
                  className="flex items-center gap-2 w-full border-2 border-dashed border-gray-300 rounded-lg p-4 hover:border-blue-500 cursor-pointer transition-colors group"
                >
                  <div className="p-2 rounded-full bg-blue-50 group-hover:bg-blue-100">
                    <svg
                ...
                {files.prescribedApplication && (
                  <div className="mt-2 text-sm text-gray-600">
                    <p>Selected: {files.prescribedApplication.name}</p>
                    {previews.prescribedApplication && (
                      <img
                        src={previews.prescribedApplication}
                        alt="Preview"
                        className="mt-2 max-w-full sm:max-w-xs rounded mx-auto"
                      />
                    )}
