...
const Form7 = ({ formData: initialFormData, formId }) => {
  const location = useLocation();
  const queryParams = new URLSearchParams(location.search);
  const serviceId = parseInt(queryParams.get("serviceId"));
  const serviceDescription =
    servicesData[0].services.find((service) => service.id === 7)?.title || "";
          ...
          <div id="formFinal" className="p-4">
            ...
            <div className="text-center mb-6">
              <div className="flex justify-between items-start mb-4">
                <div className="text-left flex  ml-[50%]">सेवा क्र.७</div>
              </div>
              ...
              <div className="mt-8">
                ...
                <div className="space-y-4">
                  <p>
                    ...
                    {formData.governmentServiceBranch || "_______"}या सहकारी
                    गृहनिर्माण संस्थेसाठी परिपत्रक क्र. ३ व अन्वये विकासकाने
                    सादर केलेल्या GIS सीडीची प्रत उपलब्ध करुन देणेत याव्यात ही
                    विनंती.
                  </p>
                </div>
              </div>
