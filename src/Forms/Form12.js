      ...
      <div className="w-full max-w-4xl bg-white rounded-lg shadow-lg p-8">
        ...
        <div className="space-y-6 text-sm">
          ...
          <div className="mt-8">
            ...
            >
              <b>
                विषय :- पात्र झोपडीधारक मयन झाल्यानंतर त्यांचे सहकारी गृहनिर्माण
                संस्थेतील सभासदत्व व सदनिकेचे हस्थानतारनाबाबबत कार्यवाही.
              </b>
            </p>
            ...
            <div className="space-y-4">
              <p>
                ...
                झोपडपट्टी पुनर्वसन योजनेमध्ये अनु क्र{" "}
                {formData.sahakari || "_______"} झोपडी क्र.{" "}
                {formData.jhopdi || "_______"} वर पात्र आसून मला दि.{" "}
                {formData.jhopdi || "_______"} रोजीच्या पुनर्वसन योजनेच्या सोडती
                मध्ये सदनिका क्र. {formData.sadnika || "_______"} वाटप करण्यात
                आलेली आहे. माझे पती / पत्नी यांचे दि.{" "}
                {formData.patipatni || "_______"} रोजी निधन झाले असून माझे पती /
                पत्नीच्या नंतर संस्थेमधील संभासदत्व न सदानिकेचे हस्तांतरण
