...
const UploadForm21 = ({ formData, formId, setCanProceed, onFormSubmit }) => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2 flex justify-center mt-6">
              <button
                ...
                className={`px-6 py-2 rounded-md text-white font-medium ${isLoading || !Object.values(files).some((file) => file)
